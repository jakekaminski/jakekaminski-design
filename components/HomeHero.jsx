            ...
            <div className="mx-auto max-w-2xl">
              <div className="max-w-lg">
                <h1 className="mt-10 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                  I help businesses make their websites cost less and do more.
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Hi! I'm Jake, a web designer & developer from Central Illinois. I specialize in making your website impactful, cost-effective, and easy to manage.
                </p>
                <div className="mt-10 flex items-center gap-x-6">
                  ...
                  <a href="#" className="text-sm font-semibold leading-6 text-gray-900 hover:underline hover:underline-offset-2">
            ...
            <div className="shadow-lg md:rounded-3xl">
              <div className="bg-yellow-500 [clip-path:inset(0)] md:[clip-path:inset(0_round_theme(borderRadius.3xl))]">
                <div
                  ...
                  aria-hidden="true"
                />
                <img src="images/headshot.jpg" alt="Jake Kaminski" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
