...
<figure>
    <img
        ...
        alt="Precision Planting old website homepage"
    />
    <figcaption className="text-center">
        Precision Planting's previous website homepage.
    </figcaption>
</figure>
...
<Callout emoji="♟️">**Strategy:** create a new digital design system.</Callout>
...
<figure>
    ...
    />
    <figcaption className="text-center">
        Precision's previous product page was one looooooong list
    </figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption className="text-center">
        Card sorting with customers and dealers to understand how they grouped
        products
    </figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption className="text-center">
        Precision Planting's new design system.
    </figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption className="text-center">
        The new hero sections and CTAs have a bolder, high-contrast look.
    </figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption className="text-center">
        Buttons and links were designed to fit into primary page elements.
    </figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption className="text-center">
        Precision Planting's Storybook with the new design system.
    </figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption className="text-center">
        Metrics improved across the board in the first three months since
        launch.
    </figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption className="text-center">
        Site speed and accessibility scores improved significantly.
    </figcaption>
</figure>

## Wrap up

This was definitely one of the most challenging and rewarding projects I've
worked on. It was a great opportunity to work with a talented team and help them
create a website that truly reflects their brand and values.

I learned a lot about user research, design systems, and development in the
process, and I'm excited to see how the new website will continue to evolve and
grow!

<Callout>
    **Takeaway:** A design system is a powerful tool that can help you create a
    consistent and scalable website. It can also make development much faster
    and easier.
</Callout>
