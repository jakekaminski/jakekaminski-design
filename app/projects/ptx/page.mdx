...
<figure>
    <img src="/images/ptx-brand-guidelines.png" alt="PTx brand guidelines" />
    <figcaption className="text-center">
        PTx's preliminary brand guidelines.
    </figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption className="text-center">
        Figma Slides was used to create the digital brand guidelines document.
    </figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption className="text-center">
        Our teams provided a _lot_ of examples of their designs for various
        platforms and apps.
    </figcaption>
</figure>
